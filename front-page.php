...
<div class="card inner-shadow bg-dark border-light rounded">
  <h3 class="card-header text-center">Spotlight</h3>
  <div class="card-body">
...
<div class="container">
  <div class="row">
      <div class="col-md-6">
        <div class="card bg-dark inner-shadow border border-light">
