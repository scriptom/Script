...
<footer class="footer inner-shadow container">
  <div class="footer-top">
    <div class="row">
      ...
      <div class="col-md-3">
        ...
        <p>Av. Teher&aacute;n, Montalb&aacute;n. Parroquia La Vega <br>
  ...
  <div class="footer-bottom">
    <div class="container">
      <p class="copyright-section">&copy; <?php echo date('Y'); ?> SCRIPT CIC UCAB - TODOS LOS DERECHOS RESERVADOS. Caracas-Venezuela</p>
    </div>
  </div>
</div> <!-- /.container -->
</footer>
