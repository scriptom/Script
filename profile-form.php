...
<div class="tml tml-profile" id="theme-my-login<?php $template->the_instance(); ?>">
	...
	<form id="your-profile" action="<?php $template->the_action_url( 'profile', 'login_post' ); ?>" method="post">
		...
		<tr class="tml-user-admin-bar-front-wrap">
			...
			<td class="form-check">
				<label for="admin_bar_front" class="form-check-label"><input type="checkbox" name="admin_bar_front" class="form-check-input" id="admin_bar_front" value="1"<?php checked( _get_admin_bar_pref( 'front', $profileuser->ID ) ); ?> />
		...
		<tr class="tml-user-login-wrap">
			...
			<td><input type="text" name="user_login" id="user_login" value="<?php echo esc_attr( $profileuser->user_login ); ?>" disabled="disabled" class="regular-text form-control" /> <span class="description"><?php _e( 'Usernames cannot be changed.', 'theme-my-login' ); ?></span></td>
		</tr>

		<tr class="tml-first-name-wrap">
			<th><label for="first_name"><?php _e( 'First Name', 'theme-my-login' ); ?></label></th>
			<td><input type="text" name="first_name" id="first_name" value="<?php echo esc_attr( $profileuser->first_name ); ?>" class="regular-text form-control" /></td>
		</tr>

		<tr class="tml-last-name-wrap">
			<th><label for="last_name"><?php _e( 'Last Name', 'theme-my-login' ); ?></label></th>
			<td><input type="text" name="last_name" id="last_name" value="<?php echo esc_attr( $profileuser->last_name ); ?>" class="regular-text form-control" /></td>
		</tr>
		...
		<tr class="tml-nickname-wrap">
			...
			<td><input type="text" name="nickname" id="nickname" value="<?php echo esc_attr( $profileuser->nickname ); ?>" class="regular-text form-control" /></td>
		</tr>
		...
		<tr class="tml-user-email-wrap">
			...
			<td><input type="text" name="email" id="email" value="<?php echo esc_attr( $profileuser->user_email ); ?>" class="regular-text form-control" /></td>
			<?php
		...
		<tr class="tml-user-url-wrap">
			...
			<td><input type="text" name="url" id="url" value="<?php echo esc_attr( $profileuser->user_url ); ?>" class="regular-text code form-control" /></td>
		</tr>
		...
		<tr class="tml-user-contact-method-<?php echo $name; ?>-wrap">
			...
			<td><input type="text" name="<?php echo $name; ?>" id="<?php echo $name; ?>" value="<?php echo esc_attr( $profileuser->$name ); ?>" class="regular-text form-control" /></td>
		</tr>
		<?php
			}
		?>
		...
		<tr class="tml-user-description-wrap">
			...
			<td><textarea name="description" id="description form-control" rows="5" cols="30"><?php echo esc_html( $profileuser->description ); ?></textarea><br />
		...
		<tr id="password" class="user-pass1-wrap">
			...
			<td>
				...
				<button type="button" class="btn btn-secondary wp-generate-pw hide-if-no-js form-control"><?php _e( 'Generate Password', 'theme-my-login' ); ?></button>
				<div class="wp-pwd hide-if-js">
					<span class="password-input-wrapper">
						<input type="password" name="pass1" id="pass1" class="regular-text form-control" value="" autocomplete="off" data-pw="<?php echo esc_attr( wp_generate_password( 24 ) ); ?>" aria-describedby="pass-strength-result" />
					</span>
					<div style="display:none" id="pass-strength-result" aria-live="polite"></div>
					<button type="button" class="btn btn-secondary wp-hide-pw hide-if-no-js form-control" data-toggle="0" aria-label="<?php esc_attr_e( 'Hide password', 'theme-my-login' ); ?>">
						<span class="dashicons dashicons-hidden"></span>
						<span class="text"><?php _e( 'Hide', 'theme-my-login' ); ?></span>
					</button>
					<button type="button" class="btn btn-secondary wp-cancel-pw hide-if-no-js form-control" data-toggle="0" aria-label="<?php esc_attr_e( 'Cancel password change', 'theme-my-login' ); ?>">
		...
		<tr class="user-pass2-wrap hide-if-js">
			...
			<td>
			<input name="pass2" type="password" id="pass2" class="regular-text form-control" value="" autocomplete="off" />
		...
		<p class="tml-submit-wrap">
			...
			<input type="submit" class="btn btn-primary form-control" value="<?php esc_attr_e( 'Update Profile', 'theme-my-login' ); ?>" name="submit" id="submit" />
		</p>
	</form>
</div>
